...
import org.apache.spark.api.php.PhpRDD
...
import org.apache.spark.sql.execution.EvaluatePhp
...
class DataFrame private[sql](
  ...
  protected[sql] def javaToPhp: JavaRDD[Array[Byte]] = {
    val structType = schema  // capture it for closure


    val   file = new java.io.File("/home/gt/scala_worker6.txt")
    val   fos = new java.io.FileWriter(file,true);
    val   osw = new BufferedWriter(fos);
      osw.write("#####" + structType.getClass)
      osw.newLine()
    ...
    val rdd = queryExecution.toRdd.map(EvaluatePhp.toJava(_, structType))
    EvaluatePhp.javaToPhp(rdd)
  }

  protected[sql] def collectToPhp(): Int = {
    withNewExecutionId {
      PhpRDD.collectAndServe(javaToPhp.rdd)
    }
  }
  ////////////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////
