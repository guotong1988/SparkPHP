...
private[spark] class PhpPartitioner(
  override val numPartitions: Int,
  val phpPartitionFunctionId: Long)
  extends Partitioner {
  ...
  override def equals(other: Any): Boolean = other match {
    case h: PhpPartitioner =>
      h.numPartitions == numPartitions && h.phpPartitionFunctionId == phpPartitionFunctionId
    case _ =>
      false
  }

  override def hashCode: Int = 31 * numPartitions + phpPartitionFunctionId.hashCode
}
