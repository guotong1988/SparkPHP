...
private[spark] object PhpUtils {
  /** Get the PHPPATH for SparkPHP, either from SPARK_HOME, if it is set, or from our JAR */
  def sparkPhpPath: String = {
    ...
    phpPath.mkString(File.pathSeparator)
  }

  /** Merge PYTHONPATHS with the appropriate separator. Ignores blank strings. */
  def mergePhpPaths(paths: String*): String = {
