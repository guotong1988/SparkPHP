 ...
 */
private[php] class WritableToJavaConverter(
 ...
 */
private[php] class JavaToWritableConverter extends Converter[Any, Writable] {
...
private[php] object PhpHadoopUtil {
